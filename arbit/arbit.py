...
UNISWAP_FACTORY_CHECKSUM_ADDRESS = "0xc0a47dFe034B400B47bDaD5FecDa2621de6c4d95"
...
KYBER_NETWORK_PROXY_CHECKSUM_ADDRESS = "0x818E6FECD516Ecc3849DAf6845e3EC868087B755"
...
BANCOR_CONTRACT_REGISTRY_CHECKSUM_ADDRESS = "0x52Ae12ABe5D8BD778BD5397F99cA900624CfADD4"
...
async def monitor_tokens(tokens_details=None):
    ...
    for token in tokens_details['tokens']:
        try:
            ...
            log.error("{}: {}".format(exctype.__name__, value))
            main_task.cancel()
            return
